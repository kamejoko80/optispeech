...
def filter_one_split(split_dir: Path, max_s: float, ext: str, make_backup: bool):
...
def main():
    ...
    filter_one_split(train_dir, args.max_s, args.ext, args.backup)
    filter_one_split(val_dir, args.max_s, args.ext, args.backup)
